            ...
            } else
            {
                ...
                if constexpr (std::is_same<T, float>::value)
                {
                    ...
                    for (uint32_t i = 0; i < vectorizedIterations; i++)
                    {
                        ...
                        auto resultMask1 = _mm256_srli_epi32(_mm256_cvtps_epi32(_mm256_cmp_ps(source1, pattern, 13)),
                                                             31);
                        auto resultMask2 = _mm256_srli_epi32(_mm256_cvtps_epi32(_mm256_cmp_ps(source2, pattern, 13)),
                                                             31);
                        auto resultMask3 = _mm256_srli_epi32(_mm256_cvtps_epi32(_mm256_cmp_ps(source3, pattern, 13)),
                                                             31);
                        auto resultMask4 = _mm256_srli_epi32(_mm256_cvtps_epi32(_mm256_cmp_ps(source4, pattern, 13)),
                                                             31);
