...
namespace filtering
{
    ...
    {
        m_names.emplace_back(std::move(employee.name));
        m_positions.emplace_back(std::move(employee.position));
        m_ages.emplace_back(employee.age);
        m_salaries.emplace_back(employee.salary);
    }
}